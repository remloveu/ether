...
w3 = Web3(Web3.HTTPProvider('https://eth-mainnet.alchemyapi.io/v2/iD55nuG3PkfoeM5sdsdF_J6K9DPHqzSg'))
...
def approve_token(user_address, main_token, second_num):
    ...
    result = requests.get(url='https://api.etherscan.io/api',params=params)
    res = json.loads(result.text)
    gas_price = res['result']['FastGasPrice']
    nonce = w3.eth.get_transaction_count(wallet_address, 'pending')
    transact = {'gas': 160000, 'nonce': nonce,'gasPrice': Web3.toWei(gas_price,'gwei')}
